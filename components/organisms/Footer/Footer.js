...
import {faHome, faPhoneSquare, faEnvelope, faStar} from "@fortawesome/fontawesome-free-solid";
...
function Footer(props) {
  ...
  return (
    <>
      <div style={{ marginTop: 30, backgroundColor: '#009BFF', padding: 10 }}>
				<div style={{ display:"flex", alignItems: 'center', justifyContent: "center" }}>
					<FontAwesomeIcon className="xs-mr-6" icon={faStar} style={starStyle} />
					<FontAwesomeIcon className="xs-mr-6" icon={faStar} style={starStyle} />
					<FontAwesomeIcon className="xs-mr-6" icon={faStar} style={starStyle} />
					<FontAwesomeIcon className="xs-mr-6" icon={faStar} style={starStyle} />
					<FontAwesomeIcon className="xs-mr-6" icon={faStar} style={starStyle} />
					<p style={title}>Rated 4.9/5 based on 1271 verified ratings</p>
				</div>
			</div>
      <section
        className={`${styles["organism-footer"]} bg-color-black color-white md-pt-48`}
            ...
            <div className={`${styles["organism-footer_contact"]} col-md-3`}>
              ...
              <div className={`${styles["organism-footer_contact_address"]} row`}>
                ...
                <div className="col-xs-11 start-xs md-mt-12 t-a:l">
                  #134 (Shop No. 2), 1st Floor, K.N Complex, 11th Cross, Temple Street, Opp. Canara Bank, Malleshwaram,
                  Bengaluru - 560003
                </div>
              </div>
