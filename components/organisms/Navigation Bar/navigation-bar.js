...
import './navigation-bar.module.css';
...
function NavigationBar(props) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('resize', function () {
            ...
            if (window.innerWidth < 1024) {
                var navbar = document.querySelector('.organism-navigation-bar .container-fluid > .row:nth-child(2)');
                navbar.classList.remove('stickyNav');
                $('.hideWhenSticky').show();
                $('.organism-navigation-bar_logo').removeClass('stickyLogoInNav');
            }
        });
            ...
            if (window.innerWidth > 1023) {
                ...
                if (navbar) {
                    ...
                    if (window.pageYOffset > sticky) {
                        ...
                        $('.hideWhenSticky').hide();
                        $('.organism-navigation-bar_logo').addClass('stickyLogoInNav');
                    } else {
                        navbar.classList.remove('stickyNav');
                        $('.hideWhenSticky').show();
                        $('.organism-navigation-bar_logo').removeClass('stickyLogoInNav');
    ...
    return (
        <section className={styles['organism-navigation-bar']}>
            <div className={`${styles['container-fluid']} xs-mb-6`}>
                        ...
                        <Link href={content.firstRow.logo.link}>
                            <a>
                                <img
                                    ...
                                    className={content.firstRow.logo.classes.join(' ')}
                ...
                <div className="row middle-xs xs-pt-6 xs-pb-6 center-xs">
                    <div className="col-xs-10 start-xs hidden-md-up">
                        <div className="row start-xs">
                            {content.firstRow.contact.numbers.map((c, i) => (
                                <div className={`col-xs-12 col-sm-4 ${i === 0 ? 'xs-mb-6' : ''}`} key={i}>
                                    <a
                    ...
                    <div className="col-xs-2 end-xs hidden-md-up">
                        <a
                            ...
                            onClick={() => {
                                $('.listContainer').slideToggle('slow');
                                setMenuStatus((s) => !s);
                            }}
                        >
                            ...
                            <ul className="d:i-block">
                                {linksToRender.map((l, i) => (
                                    <li
                                        ...
                                        } ${l.hideWhenSticky ? 'hideWhenSticky' : ''} ${
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {l.icon && !isMobile ? (
                                                <FontAwesomeIcon
                                                    className={`${l.text ? 'p:r xs-ml-6 hidden-sm-down' : ''}`}
