...
function Editorial(props) {
	...
	let headlinePosition = props.headlinePosition
		? props.headlinePosition
		: 'left';
			...
			<div className="container-fluid">
				...
				>
					<div className="col-xs-12 hidden-md-up">
						{headlineSize === '1' && (
							<h1 className={`${headlinePositionClass} xs-mb-12`}>
								{props.headline}
							</h1>
						)}
						{headlineSize === '2' && (
							<h2 className={`${headlinePositionClass} xs-mb-12`}>
								{props.headline}
							</h2>
						)}
						{headlineSize === '3' && (
							<h3 className={`${headlinePositionClass} xs-mb-12`}>
								{props.headline}
							</h3>
						)}
					</div>
					...
					<div
						className={`col-xs-12 col-md-6 ${
							side === 'right' ? 'end-xs' : 'start-xs'
						}`}
					>
						<img
							className={styles['organism-editorial-image']}
							src={props.img}
							alt="editorial-image"
						/>
					</div>
					...
					>
						{headlineSize === '1' && (
							<h1 className={`hidden-sm-down ${headlinePositionClass}`}>
								{props.headline}
							</h1>
						)}
						{headlineSize === '2' && (
							<h2 className={`hidden-sm-down ${headlinePositionClass}`}>
								{props.headline}
							</h2>
						)}
						{headlineSize === '3' && (
							<h3 className={`hidden-sm-down ${headlinePositionClass}`}>
								{props.headline}
							</h3>
						)}

						<div
							className={`t-a:l xs-mt-12 md-mt-24 ${styles['organism-editorial-body']}`}
						>
							{props.children}
						</div>
