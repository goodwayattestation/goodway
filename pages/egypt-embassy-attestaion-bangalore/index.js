...
function EgyptAttestation() {
    return (
        <Layout
            title="Attestation Service for Egypt in Bangalore - Egypt Certificate Attestation Near Me"
            description="Egypt Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666"
            keywords="Egypt Embassy Documents Attestation Services, Certificate Attestation For Egypt, Egypt Embassy Certificate Attestation in Bangalore, Egypt Embassy Attestation, Egypt Embassy Attestation in India"
            canonical="https://www.goodwayattestation.com/egypt-embassy-attestaion-bangalore"
            pageHeader="Attestation Service for Egypt in Bangalore"
        >
            <div className={styles['routes-egypt-attestation']}>
                ...
                <AttestationTemplate headline="Attestation Service For Egypt In Bengaluru" tabs={Content}>
                    <div className={styles['routes-egypt-attestation_content']}>
                        ...
                        <div className="row color-black center-xs xs-mt-36 md-mt-48">
                            ...
                            <div className={`${styles['educationalCertificateAttestation']} col-xs-12 col-md-6`}>
                                ...
                                <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                    We also take over Ministry of Foreign Affairs of Egypt (MOFA of Egypt)* After
