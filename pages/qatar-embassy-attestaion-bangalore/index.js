    ...
    return (
        ...
        >
            <div className={styles['routes-qatar-attestation']}>
                ...
                <AttestationTemplate headline="Attestation Service For Qatar In Bengaluru" tabs={Content}>
                    <div className={styles['routes-qatar-attestation_content']}>
                        <div className="row center-xs xs-mt-12 md-mt-54">
                            <div className="col-xs-12">
                                <h2 className="color-black">Certificates Required For Qatar Embassy Attestation</h2>
                            </div>
                        </div>
                        <div className="row color-black center-xs xs-mt-36 md-mt-48">
                            ...
                            <div className={`${styles['educationalCertificateAttestation']} col-xs-12 col-md-6`}>
                                ...
                                <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                    We also take over Ministry of Foreign Affairs of Qatar (MOFA of Qatar)* After
                        ...
                        <div className="row color-black xs-mt-36 md-mt-48">
                            <div className="col-xs-12">
                                <p>
                                    Qatar is one of the most advanced-economy countries in the Arab region and has the
                                    highest per capita income. Qatar wields considerable influence on the world state
                                    despite its small size.
                                </p>

                                <p className="xs-mt-12">
                                    Make your Qatar travel formalities easier with elaborate document attestation. You
                                    may travel to Qatar for tour, business, immigration, job and many other reasons.
                                    Meet up with the friendly and helpful professionals at Goodway Attestation and get
                                    their guidance and advice about attestation services for Qatar in Bengaluru.
                                </p>

                                <p className="xs-mt-12">
                                    You need not go beyond Goodway Attestation for document attestation services for
                                    Qatar in Bengaluru.
                                </p>

                                <p className="xs-mt-12">
                                    Ensure minimal hassle during either admission to a higher education institution or
                                    background verification at the time of newly joining a company in Qatar. Our
                                    professionals will be glad to help you with educational certificates attestation for
                                    Qatar. You can also get your work experience certificates attested for Qatar, at
                                    Goodway Attestation, Bengaluru.
                                </p>

                                <p className="xs-mt-12">
                                    Certain rules and regulations require that your documents be attested by the Embassy
                                    of Qatar. Make your task easier by approaching our friendly and helpful
                                    professionals at Goodway Attestation to get all your documents and certificates
                                    attested by the Embassy of Qatar, in Bengaluru itself.
                                </p>

                                <p className="xs-mt-12">
                                    If you need to get your certificates, documents, and others attested by different
                                    authorities of Qatar,, you need not go out of Bengaluru. You just need to get the
                                    job done by the professionals at Goodway Attestation, in Bengaluru.
                                </p>
                            </div>
                        </div>
                    </div>
