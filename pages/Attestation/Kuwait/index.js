...
function KuwaitAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for Kuwait in Bangalore - Kuwait Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Kuwait Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'kuwait attestation services in bangalore, Degree Certificate Attestation Services For Kuwait, Kuwait Embassy Attestation'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/kuwait-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for Kuwait in Bangalore';
    }, []);

    return (
        <div className="routes-kuwait-attestation">
            <NavigationBar showTrackStatusBtn={true} />
            <AttestationTemplate headline="Attestation Service For Kuwait In Bengaluru" tabs={Content}>
                <div className="routes-kuwait-attestation_content">
                    <div className="row center-xs xs-mt-12 md-mt-54">
                        <div className="col-xs-12">
                            <h2 className="color-black">Certificates Required For Kuwait Embassy Attestation</h2>
                        </div>
                    </div>
                    <div className="row color-black center-xs xs-mt-36 md-mt-48">
                        ...
                        <div className="col-xs-12 col-md-6 educationalCertificateAttestation">
                            ...
                            <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                We also take over Ministry of Foreign Affairs of Kuwait (MOFA of Kuwait)* After
