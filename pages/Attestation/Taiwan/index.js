...
function TaiwanAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for Taiwan in Bangalore - Taiwan Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Taiwan Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'Certificate Attestation Service for Taiwan in Bangalore, Taiwan Embassy Certificate Attestation, Taiwan Embassy Attestation in Bangalore, Taiwan Embassy Attestation'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/taiwan-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for Taiwan in Bangalore';
    }, []);

    return (
        <div className="routes-taiwan-attestation">
            ...
            <AttestationTemplate headline="Attestation Service For Taiwan In Bengaluru" tabs={Content}>
                <div className="routes-taiwan-attestation_content">
