...
function VietnamAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for Vietnam in Bangalore - Vietnam Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Vietnam Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'Certificate Attestation for Vietnam, Vietnam Embassy Certificate Attestation in bengaluru, Vietnam Embassy Attestation'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/vietnam-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for Vietnam in Bangalore';
    }, []);

    return (
        <div className="routes-vietnam-attestation">
            <NavigationBar showTrackStatusBtn={true} />
            <AttestationTemplate headline="Attestation Service For Vietnam In Bengaluru" tabs={Content}>
                <div className="routes-vietnam-attestation_content">
                    <div className="row center-xs xs-mt-12 md-mt-54">
                        <div className="col-xs-12">
                            <h2 className="color-black">Certificates Required For Vietnam Embassy Attestation</h2>
                        </div>
                    </div>
                    <div className="row color-black center-xs xs-mt-36 md-mt-48">
                        ...
                        <div className="col-xs-12 col-md-6 educationalCertificateAttestation">
                            ...
                            <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                We also take over Ministry of Foreign Affairs of Vietnam (MOFA of Vietnam)* After
