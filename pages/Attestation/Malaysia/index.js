...
function MalaysiaAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for Malaysia in Bangalore - Malaysia Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Malaysia Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'Malaysia Embassy Attestation, Malaysia Embassy Certificate Attestation in Bangalore, Certificate Attestation Service for Malaysia, Malaysia Embassy Attestation in India'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/malaysia-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for Malaysia in Bangalore';
    }, []);

    return (
        <div className="routes-malaysia-attestation">
            ...
            <AttestationTemplate headline="Attestation Service For Malaysia In Bengaluru" tabs={Content}>
                <div className="routes-malaysia-attestation_content">
                    ...
                    <div className="row color-black center-xs xs-mt-36 md-mt-48">
                        ...
                        <div className="col-xs-12 col-md-6 educationalCertificateAttestation">
                            ...
                            <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                We also take over Ministry of Foreign Affairs of Malaysia (MOFA of Malaysia)* After
