...
function SaudiAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for Saudi in Bangalore - Saudi Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Saudi Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'Certificate Attestation Service for Saudi in Bangalore, Saudi Embassy Attestation, Saudi Embassy attestation service in Bangalore, Embassy Attestation Expert for Saudi Arabia'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/saudi-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for Saudi in Bangalore';
    }, []);

    return (
        <div className="routes-saudi-attestation">
            <NavigationBar showTrackStatusBtn={true} />
            <AttestationTemplate headline="Attestation Service For Saudi In Bengaluru" tabs={Content}>
                <div className="routes-saudi-attestation_content">
                    <div className="row center-xs xs-mt-12 md-mt-54">
                        <div className="col-xs-12">
                            <h2 className="color-black">Certificates Required For Saudi Embassy Attestation</h2>
                        </div>
                    </div>
                    <div className="row color-black center-xs xs-mt-36 md-mt-48">
                        ...
                        <div className="col-xs-12 col-md-6 educationalCertificateAttestation">
                            ...
                            <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                We also take over Ministry of Foreign Affairs of Saudi (MOFA of Saudi)* After Attesting
                    ...
                    <div className="row color-black xs-mt-36 md-mt-48">
                        <div className="col-xs-12">
                            <p>
                                Being the cradle of Islam, Saudi Arabia is one the premier pilgrimage destinations in
                                the world. It is the largest economy in the Middle-East and the 18th largest in the
                                world. Saudi Arabia is one of the largest petroleum products exporters in the world.
                            </p>

                            <p className="xs-mt-12">
                                People visiting Saudi Arabia need to have all their documents and certificates attested
                                by different authorities of Saudi Arabia, to ensure that their visit is with minimal
                                hassle.
                            </p>

                            <p className="xs-mt-12">
                                You do not have to go out of Bengaluru to get your certificates and documents attested
                                by different authorities of Saudi Arabia. You can get them attested in Bengaluru itself,
                                approaching our friendly and helpful professionals at Goodway Attesting.
                            </p>

                            <p className="xs-mt-12">
                                You need to get your documents attested by the Embassy of Saudi Arabia to as part of
                                your travel visa application process. Goodway Attestation makes your task simpler by
                                getting your documents attested by the Embassy of Saudi Arabia, in Bengaluru itself. Be
                                assured that the fees for attesting your papers are nominal!
                            </p>

                            <p className="xs-mt-12">
                                Saudi Arabia has an extreme climate during summer, thus people travelling there during
                                that season need to have important certificates or documents such as medical and fitness
                                certificate. For those travelling to Saudi Arabia for higher studies, educational
                                certificates and other relevant documents are important. The professionals at Goodway
                                Attestation in Bengaluru help you with attestation for Saudi Arabia at nominal costs.
                            </p>
                        </div>
                    </div>
                </div>
