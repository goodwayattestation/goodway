...
function ChinaAttestation(props) {
    useEffect(() => {
        document.title = 'Attestation Service for China in Bangalore - China Certificate Attestation Near Me';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'China Certificate Attestation Service in Bangalore for Birth & Marriage Certificate, Education & Commercial Documents. For Quick Service Call:9148889666'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'Certificate Attestation Service for China in Bangalore, China Embassy Certificate Attestation in Bengaluru, China Embassy Attestation, china embassy attestation fees, chinese embassy translation services, apostille chinese embassy'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/china-attestation');

        document.querySelector('#commonPageHeader').innerHTML = 'Attestation Service for China in Bangalore';
    }, []);

    return (
        <div className="routes-china-attestation">
            <NavigationBar showTrackStatusBtn={true} />
            <AttestationTemplate headline="Attestation Service For China In Bengaluru" tabs={Content}>
                <div className="routes-china-attestation_content">
                    <div className="row center-xs xs-mt-12 md-mt-54">
                        <div className="col-xs-12">
                            <h2 className="color-black">Certificates Required For China Embassy Attestation</h2>
                        </div>
                    </div>
                    <div className="row color-black center-xs xs-mt-36 md-mt-48">
                        ...
                        <div className="col-xs-12 col-md-6 educationalCertificateAttestation">
                            ...
                            <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                We also take over Ministry of Foreign Affairs of China (MOFA of China)* After Attesting
