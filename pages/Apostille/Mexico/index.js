...
function MexicoApostille(props) {
    useEffect(() => {
        document.title = 'Mexico Apostille Service in Bangalore - Degree & Marriage Certificate Apostille in India';
        document
            .querySelector('meta[name="description"]')
            .setAttribute(
                'content',
                'Mexico Certificate Apostille Attestation Service in Bangalore. Call:9148889666. Mexico MEA Apostille for Degree Certificates, Birth & Marriage Certificate Apostille for Mexico within 4 Days.'
            );
        document
            .querySelector('meta[name="keywords"]')
            .setAttribute(
                'content',
                'degree certificate apostille for Mexico, marriage certificate apostille for Mexico, Mexico mea apostille service, birth certificate apostille attestation for Mexico, Legalisation for Mexico, Apostille for documents from Mexico, Mexico Embassy Apostille'
            );
        document
            .querySelector('link[rel="canonical"]')
            .setAttribute('href', 'https://www.goodwayattestation.com/mexico-apostille');

        document.querySelector('#commonPageHeader').innerHTML = 'Mexico Apostille Service in Bangalore';
    }, []);

    return (
        <div className="routes-mexico-apostille">
            <NavigationBar showTrackStatusBtn={true} />
            <ApostillePageTemplate headline="Apostille Service For Mexico In Bengaluru">
                <div className="routes-mexico-apostille_content">
                    <p>
