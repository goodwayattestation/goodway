            ...
            <div className={styles['routes-italy-apostille']}>
                ...
                <ApostillePageTemplate headline="Apostille Service For Italy In Bengaluru">
                    <div className={styles['routes-italy-apostille_content']}>
                        ...
                        <p className="xs-mt-12 md-mt-18">
                            Italy is one of the popular tourist destinations in the world. Historically, its capital
                            Rome and major city Venice have been the stage for noted English playwright William
                            Shakespeare’s plays.
                        </p>

                        <p className="xs-mt-12 md-mt-18">
                            Through apostille services, we at Goodway Attestation will make your Italy travel plans a
                            smooth sailing. Get your educational and experience{' '}
                            <b>certificates and important documents apostilled by the Embassy of Italy,</b> through
