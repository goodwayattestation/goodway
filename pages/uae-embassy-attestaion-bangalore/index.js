    ...
    return (
        ...
        >
            <div className={styles['routes-UAE-attestation']}>
                ...
                <AttestationTemplate headline="Attestation Service For UAE In Bengaluru" tabs={Content}>
                    <div className={styles['routes-UAE-attestation_content']}>
                        <div className="row center-xs xs-mt-12 md-mt-54">
                            <div className="col-xs-12">
                                <h2 className="color-black">Certificates Required For UAE Embassy Attestation</h2>
                            </div>
                        </div>
                        <div className="row color-black center-xs xs-mt-36 md-mt-48">
                            ...
                            <div className={`${styles['educationalCertificateAttestation']} col-xs-12 col-md-6`}>
                                ...
                                <p className="t-a:j xs-mt-18 md-mt-24 md-ml-48 f-w:500">
                                    We also take over Ministry of Foreign Affairs of UAE (MOFA of UAE)* After Attesting
                                    from country from which the documents are issued it has to be Attested from MOFA
                                    Ministry of Foreign Affairs of the Country where you are going for employment.
                                </p>
                            </div>
                        </div>
                        <div className="row color-black xs-mt-36 md-mt-48">
                            <div className="col-xs-12">
                                <p>
                                    The United Arab Emirates, a confederation of seven Emirates, is fast emerging as a
                                    major economic and business zone in the Middle-East. With a future-oriented economy,
                                    the UAE is stands 26th in the list of best nations in the world to do business.
                                </p>

                                <p className="xs-mt-12">
                                    Many Indians have worked and settled there. Goodway Attestation assists in quick
                                    processing of visa applications of Indians travelling to the UAE either for work,
                                    tour or immigration. Residents of Bengaluru need not look beyond Goodway Attestation
                                    to get certificates and documents attestation services for UAE in Bengaluru.
                                </p>

                                <p className="xs-mt-12">
                                    You can trust the professionals at Goodway Attestation to guide you through the
                                    necessary paperwork and attestation for UAE in Bengaluru. They are knowledgeable
                                    about the terms and conditions that visitors and workers have to abide by, during
                                    their stay in the UAE.
                                </p>

                                <p className="xs-mt-12">
                                    Bring all your important certificates for attestation for UAE in Bengaluru, itself,
                                    at Goodway Attestation. They can be educational, experience, medical or other
                                    important certificates. This will surely make your UAE travel hassle-free.
                                </p>

                                <p className="xs-mt-12">
                                    Certain important certificates and documents need UAE embassy attestation. No
                                    worries, you can get your papers attested in Bengaluru itself, through our
                                    resourceful and friendly professionals at Goodway Attestation. You can focus on
                                    other related important tasks.
                                </p>

                                <p className="xs-mt-12">
                                    For your higher studies in the UAE, you can get all educational certificates for UAE
                                    to be attested in Bengaluru. Our professionals will elaborately guide you in this
                                    process so that your admission and enrolment formalities for higher studies in the
                                    UAE are hassle-free.
                                </p>
                            </div>
                        </div>
